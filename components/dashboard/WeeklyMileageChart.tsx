...
export function WeeklyMileageChart({ data }: { data: MileageWeek[] }) {
  ...
  return (
    <section className="area-chart card-enter app-card flex min-h-[310px] min-w-0 flex-col p-4 sm:min-h-[330px] sm:p-6">
      ...
      {hasMileage ? <div className="mt-5 min-h-[220px] min-w-0 w-full flex-1 sm:min-h-[230px]">
        ...
        <div className="mt-5 grid min-h-[230px] flex-1 place-items-center rounded-2xl bg-surface-subtle text-center">
